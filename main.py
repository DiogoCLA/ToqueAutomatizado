...
def main():
    ...
    while True:
            ...
            if list_toques[i].is_active and curr_hour < list_toques[i].time:  # Se estiver ativo e ainda não deu a hora
                ...
                while True:
                    ...
                    if curr_hour > list_toques[i].time:  # Quando der a hora
                        data, fs = sf.read(list_toques[i].sound_name,
                                           dtype='float32')  # Converter .WAV para NumPy Array
        ...
        while '01:00' > curr_hour > '03:00':  # Enquanto não estiver entre 1 e 3 da manhã
